...
// Minecraft.Windows.exe imports GetFileVersionInfoSizeW from VERSION.dll.
// Windows searches the EXE's own folder before System32, so a file named
// version.dll next to the game is loaded automatically at launch.
// Every export is forwarded to the real system version.dll so the game
// keeps working, while DllMain starts our threads.
#include <windows.h>
